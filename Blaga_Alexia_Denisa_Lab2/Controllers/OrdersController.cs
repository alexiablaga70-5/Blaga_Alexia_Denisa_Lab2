...
namespace Blaga_Alexia_Denisa_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Blaga_Alexia_Denisa_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var blaga_Alexia_Denisa_Lab2Context = _context.Orders.Include(o => o.Book).Include(o => o.Customer);
            return View(await blaga_Alexia_Denisa_Lab2Context.ToListAsync());
        }
